...
def main():
    # print("https://www.agh.edu.pl/wspolpraca/oferta-dla-biznesu")
    # print(get_tags("https://www.agh.edu.pl", "https://www.agh.edu.pl/wspolpraca/oferta-dla-biznesu"))
    # print("https://www.agh.edu.pl/ksztalcenie")
    # print(get_tags("https://www.agh.edu.pl", "https://www.agh.edu.pl/ksztalcenie"))
    # print("https://www.agh.edu.pl")
    # print(get_tags("https://www.agh.edu.pl", "https://www.agh.edu.pl"))
    # print("https://www.agh.edu.pl/doktoranci/szkoly-doktorskie/szkola-doktorska-agh")
    # print(get_tags("https://www.agh.edu.pl", "https://www.agh.edu.pl/doktoranci/szkoly-doktorskie/szkola-doktorska-agh"))
    ...
    df.to_csv('urls_4000.csv', index=False, encoding='utf-8')
    df2 = pd.DataFrame({'TAGS#TEXT':database})
    df2.to_csv('database_4000.csv', index=False, encoding='utf-8')
...
def find_all_urls(starting_url):
    ...
    while i < 4000:
        ...
        get_data(database, driver.page_source, starting_url, url_to_search_through)
        other_relative_urls = find_other_relative_urls_and_get_data(driver.page_source)
...
def get_data(database, content, base_url, url):
    print(url)
    tags = get_tags(base_url, url)
...
def find_other_relative_urls_and_get_data(content):
    soup = BeautifulSoup(content, features="html.parser")
    relative_urls=[]
