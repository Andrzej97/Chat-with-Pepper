...
ITERS_NUM = Configuration.ITERS_NUM.value                       # number of iterations, used also in some file names
DATE = Configuration.DATE.value                                 # for the purpose of file naming
STARTING_URL = Configuration.STARTING_URL.value
URLS_CSV_FILENAME = 'csv_files/urls_' + DATE + '_' + str(ITERS_NUM) + '.csv' # suggested format: 'urls_<yymmdd>_<number_of_iterations>.csv'
...
def main():
    ...
    CHROME_WEB_DRIVER = webdriver.Chrome(executable_path=Configuration.CHROME_DRIVER_PATH.value)
